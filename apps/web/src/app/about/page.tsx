      ...
      <Container className="pb-20 sm:pb-28">
        <div className="grid border-y border-line lg:grid-cols-2">
          <div className="relative aspect-square bg-accent-soft">
            <Image src="/logo.png" alt="Le symbole THE TALK" fill sizes="(min-width: 1024px) 50vw, 100vw" className="object-contain p-16 sm:p-24" />
          </div>
          <div className="flex items-center bg-surface p-8 sm:p-14 lg:p-16">
            <div className="max-w-xl space-y-6 text-base leading-8 text-muted sm:text-lg">
              <p className="font-display text-4xl leading-tight tracking-[-0.035em] text-foreground sm:text-5xl">Écouter avant de conclure.</p>
              <p>
